...
void fsm_EspuiClient_state_Idle::ProcessAck(uint16_t ControlIndex, const std::string &FragmentRequest)
{
    ...
    if(!FragmentRequest.empty())
    {
        ...
        Parent->SendControlsToClient(ControlIndex, ClientUpdateType_t::UpdateNeeded, FragmentRequest);
    }
    else
    {
...
void fsm_EspuiClient_state_SendingUpdate::ProcessAck(uint16_t ControlIndex, const std::string &FragmentRequest)
{
...
void fsm_EspuiClient_state_Rebuilding::ProcessAck(uint16_t ControlIndex, const std::string &FragmentRequest)
{
...
void fsm_EspuiClient_state_Reloading::ProcessAck(uint16_t ControlIndex, const std::string &FragmentRequest)
{
    if(!FragmentRequest.empty())
    {
