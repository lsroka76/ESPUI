...
public:
    ...
    //virtual void ProcessAck(uint16_t ControlIndex, String FragmentRequest) = 0;
    virtual void ProcessAck(uint16_t ControlIndex, const std::string &FragmentRequest) = 0;
...
public:
    ...
    virtual void ProcessAck(uint16_t ControlIndex, const std::string &FragmentRequest);
